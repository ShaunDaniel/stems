...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit_attendance'])) {
        ...
        while ($volunteers_row = $userlist_sql->fetch_assoc()) {
            ...
            $attendance_sql = "INSERT INTO `attendance` (`regno`, `student_name`, `event_name`, `date`, `eventid`, `attendance_status`, `time`) VALUES ('" . $volunteers_row['regno'] . "', '" . $volunteers_row['first_name'] . "', '" . $ename_row['event_title'] . "', '" . $ename_row['event_date'] . "', '" . $ename_row['ID'] . "', '" . $choice . "','" . date("h:i:sa") . "')";
